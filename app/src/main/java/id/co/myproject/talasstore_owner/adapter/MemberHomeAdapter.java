...
public class MemberHomeAdapter extends RecyclerView.Adapter<MemberHomeAdapter.ViewHolder> {
    ...
    @NonNull
    @Override
    public MemberHomeAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_member_home, parent, false);
        return new ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull MemberHomeAdapter.ViewHolder holder, int position) {
